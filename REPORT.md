...
**На рис. 1а представлены дополнительные подтверждающие данные - история загрузок. По данным истории работы Internet Explore загрузка файла состоялась 09.03.2019 в 17:25:50**.
...
*Рис. 19a. Рабочий стол пользователя Wilferd c файлом, содержащим строки пароля* 
...
Соответствующая запись в NTUSER.dad:
*OpenSavePidlMRU*  
