...
MitreAtt&ck technique: User Execution, Malicious File, T1204.002
Вспомогательная технология Indicator Removal.
Discovery (Исследование) Network Service Discovery (T1046) и Network Share Discovery (T1135)
...
Как упоминалось выше в папке C:\Windows\Temp тоже следы деятельности злоумышленников (Рис. 11). Это приложения SDelete, инструмент командной строки, который позволяет безопасно удалять файлы и папки. SDelete перезаписывает удалённые файлы на диске, чтобы сделать их неустранимыми даже с помощью технологий восстановления. Тем самым можно предположить, что в данном случае применялась технология 
T1070	Indicator Removal
Кроме того, в папке C:\Windows\Temp можно обнаружить файлы 1, 111.bat, 2.bat, 3.bat, утилиты iepv.ziP, предназначенная для выгрузки паролей из браузера Internet Explorer, netscan_portable.zip – предназначенная для TCP-сканирования сети, RDPWInst-v1.6.2.msi программа для организации удаленного подключения.

 
Рис. 11. Содержимой папки C:\Windows\Temp
...
Рис. 15 Информация о файле Iepv.zip
...
MitreAtt&ck technique: Valid Accounts, T1078
Process Injection, T1055
Дополнительная технология: Command and Control Remote Access Software (T1219)
 (Управление и Контроль)			Использование утилиты RDP Wrapper
