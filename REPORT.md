...
|Privilege Escalation|Valid Accounts: Local Accounts, T1078.003| Получение доступа к аккаунту легитимного пользователя Wilfred|Путем запуска программы iepv были получены данные легального пользователя с административными правами|10.03.2019, 06:41:06|Wilfred|
