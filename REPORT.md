...
* <span style="color:red">Для сокрытия следов присутсвия в ходе атаки было удалено множество файлов, кроме того, была осуществленая подмена временных меток</span>.
...
На рис. 1а представлены дополнительные подтверждающие данные. Необходимо отметить, что данные представленные на рис. 1. 
