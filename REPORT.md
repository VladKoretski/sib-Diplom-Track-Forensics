...
|Вспомогательная технология|Discovery (Исследование) ||T1046|
|Вспомогательная технология|Discovery (Исследование) ||T1135|

Исследование Timeliner файла, извлеченного из RAM dump, позволило выявить, что загруженный malware был запущен 2019-03-09 в 14:31:04 UTC+0000 (Рис. 6).  
...
Таким образом, выяснилось, что пользователь разархивировал файл и запустил его 03.09.2019 года в 14:15:25. В результате чего был выполнен powershell скрипт, закодированный по стандарту base64 (Рис. 8).  
...
Кроме того, подозрительно выглядят запуски, которые хотя и легитимны, но в контексте происходящего могут означать попытку отредактировать реестр и осуществить установку каких-то приложений.  
...
Общий итог: запуск загруженное приложения запустил ряд событий: скачивание вредоносного и легитимного программного обеспечения, удаление каких-то файлов, очистку журнала Windows Defender.
...
|Вспомогательная технология|Command and Control Remote Access Software||T1219|
|Вспомогательная технология|Process Injection||T1055|
|Вспомогательная технология|Credentials from Password Stores||T1555|
...
Account Created : 2019-03-09 14:17:41Z
  ...
  --> Normal user account.  
Стоит отметить, что пароли пользователь хранил на рабочем столе (Рис. 19).  
