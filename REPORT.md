...
Таким образом, выяснилось, что пользователь разархивировал файл и запустил его 03.09.2019 года в 14:15:25 UTC (или 17:15:25 MSC). В результате чего был выполнен powershell скрипт, закодированный по стандарту base64 (Рис. 8).  
...
|Дополнительная технология|Indicator Removal|Timestomp, изменение временных мето|T1070.006|
...
Кроме того, в целях сокрытия следов на атакованном компьютере было удалено множество файлов. В период атаки было удалено более 500 файлов и папов с 09.03.2019 по 10.03.2019 (Рис. 22a, 22b). 
...
Запуск Updater.bat осуществился в 12:30:35 2019-03-10, a загруженны malware-файлы (1, 2.bat, 111.bat, iepv.zip, netscan_portable.zip) и RDPWInst-v1.6.2.msi были в период с **15:52:03 09.03.2019** до **7:07:52 10.03.2019**, то есть до запуска Updater.bat, которая и должна была их загрузить.  
Например, запись в UserClass о работе iepv.zip была внесена в 6:40, в нерабочее время:  
...
Аналогично выглядят записи о других процессах.
